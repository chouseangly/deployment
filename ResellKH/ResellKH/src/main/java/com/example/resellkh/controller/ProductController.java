...
public class ProductController {
    ...
    public ResponseEntity<ApiResponse<ProductWithFilesDto>> uploadProductWithCategoryName(
        ...
        ProductRequest request = new ProductRequest(productName, userId, categoryName, productPrice,
                discountPercent, productStatus, description, location,latitude,longitude, condition);
    ...
    public ResponseEntity<ApiResponse<List<ProductWithFilesDto>>> searchByImageUrl(@RequestParam("url") String imageUrl) {
        List<ProductWithFilesDto> result = productService.searchByImageUrl(imageUrl);
        return ResponseEntity.ok(
                new ApiResponse<>(
