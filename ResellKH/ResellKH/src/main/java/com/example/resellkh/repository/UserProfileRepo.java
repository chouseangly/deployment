...
public interface UserProfileRepo {
    ...
    @Insert("""
        INSERT INTO user_profile (
            user_id, gender, phone_number, profile_image, cover_image, birthday, address,
            telegram_url, slogan, user_name, first_name, last_name
        ) VALUES (
            #{userId}, #{gender}, #{phoneNumber}, #{profileImage}, #{coverImage}, #{birthday}, #{address},
            #{telegramUrl}, #{slogan}, #{userName}, #{firstName}, #{lastName}
        )
    """)
